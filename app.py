...
# --- NUEVOS DATOS HISTÓRICOS COMSOL PARA COMPARACIONES ---
...
# CONTROL INTERACTIVO DEL VASO SANGUÍNEO
...
# Predicciones simultáneas en vivo via IA
...
# --- GRÁFICA CONTINUA 2: COMPORTAMIENTO INTERACTIVO DEL VASO (DATOS NUEVOS) ---
st.markdown("---")
...
# Ajustado a la nueva meseta de tus nuevos datos (~94 °C)
ax3.axhline(94, color='red', linestyle='--', alpha=0.5, label='Meseta Crítica Heat-Sink (~94 °C)')
