...
# =====================================================================
# 2. ENTRENAMIENTO DEL MODELO DE LA TEMPERATURA DEL VASO (NUEVO e INTERACTIVO)
# =====================================================================
# Datos numéricos de COMSOL extraídos de vasoo.txt
...
# Mapeo numérico continuo para permitir interpolación matemática en Streamlit: Escenario A = 1.0, B = 2.0, C = 3.0
...
# =====================================================================
# Guardamos ambos modelos juntos bajo claves únicas identificables
paquete_modelos = {
...
print("¡Éxito! Ambos modelos subrogados han sido consolidados de forma segura en 'best_model.pkl'.")
